...
export default function EmployeeForm() {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <Grid container>
                <Grid item xs={6}>
                    <Controls.Input label="Full Name" name="fullName" value={values.fullName}
                    ...
                    <Controls.Input label="Mobile" name="mobile" value={values.mobile}
                ...
                <Grid item xs={6}>
                    <Controls.RadioGroup name="gender" label="Gender" value={values.gender}
